...
public class CfnNotUpdatableException extends BaseHandlerException {
    ...
    private static final HandlerErrorCode ERROR_CODE = HandlerErrorCode.NotUpdatable;

    public CfnNotUpdatableException(final Throwable cause) {
    ...
    public CfnNotUpdatableException(final String resourceTypeName,
        ...
        super(String.format(ExceptionMessages.NOT_UPDATABLE, resourceTypeName, resourceIdentifier), cause, ERROR_CODE);
    }
}
