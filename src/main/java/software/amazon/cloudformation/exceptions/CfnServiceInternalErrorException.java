...
public class CfnServiceInternalErrorException extends BaseHandlerException {

    private static final long serialVersionUID = -1646136434112354328L;
    private static final HandlerErrorCode ERROR_CODE = HandlerErrorCode.ServiceInternalError;

    public CfnServiceInternalErrorException(final Throwable cause) {
